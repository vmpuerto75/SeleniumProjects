package com.odeoncinema.listeners;
...
import static com.odeoncinema.DriverFactory.getDriver;
...
public class ScreenshotListener extends TestListenerAdapter {
    ...
    @Override
    public void onTestSuccess(ITestResult okTest) {
        try {
            WebDriver driver = getDriver();
            String screenshotDirectory = System.getProperty("screenshotDirectory");
            String screenshotAbsolutePath = screenshotDirectory + File.separator + System.currentTimeMillis() + "_" + okTest.getName() + ".png";
            File screenshot = new File(screenshotAbsolutePath);
            if (createFile(screenshot)) {
                try {
                    writeScreenshotToFile(driver, screenshot);
